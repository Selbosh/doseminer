...
[![CRAN status](https://www.r-pkg.org/badges/version/doseminer)](https://CRAN.R-project.org/package=doseminer)
<!-- badges: end -->
...
The column `output` (omitted here) represents the 'residual' text after other features have been extracted.
...
Maintained by David Selby (`david_antony.selby@dfki.de`) and Belay Birlie.
